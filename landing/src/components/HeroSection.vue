        ...
        <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          <div class="flex">
            <div class="relative flex items-center gap-x-4 rounded-full bg-white px-4 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              <span class="font-semibold text-indigo-600">Join to</span>
              <span class="h-4 w-px bg-gray-900/10" aria-hidden="true" />
              <a :href="discordUrl"
                 data-umami-event="SML:Discord"
          ...
          <h1 class="mt-10 text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">Effortless Language Learning – Anytime, Even Hands-Free!</h1>
          <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Memorize new words effortlessly using AI-driven repetition, audio learning, and visual associations – anytime, anywhere.</p>
          <div class="mt-10 flex items-center gap-x-6">
            <a href="https://app.lexidrift.com"
               data-umami-event="App"
               data-umami-event-place="hero"
               class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Start Learning Now</a>
            <a href="#how-it-works"
               data-umami-event="Learn More"
               data-umami-event-place="hero"
               class="text-sm/6 font-semiboldtext-gray-900">Learn more <span aria-hidden="true">→</span></a>
          </div>
        </div>
...
const discordUrl = 'https://discord.gg/nwFFFtsb'
</script>